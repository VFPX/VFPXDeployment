...
| .\\R.README.md | <u>README.md</u> | Template for a <u>README.md</u> to give information about your project.<br />This file need to be modified by you.<br />The file will be checked on every run, and substituted in a special way:<br /><ul><li>All space between *\<!--VERNO--\>* and *\<!--/VERNO--\>* will be replaced with *pcFullVersion* placeholder.</li><li>All space between *\<!--DeploymentDate--\>* and *\<!--/DeploymentDate--\>* will be replaced with *pcVersionDate* placeholder</li></ul> |
